...
{
    public class CreateUpdateVisiteDto
    {
        public string Fullname { get; set; }    // Full name of the client
        public string Telephone { get; set; }   // Telephone number of the client
        ...
        public decimal Prixmonture { get; set; }  // Price for the frame
