...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Optique_Domaine.Entities.Client", b =>
                {
                    b.OwnsOne("Optique_Domaine.Entities.Visite", "Visite", b1 =>
                        {
                            b1.Property<Guid>("ClientId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<DateTime>("DateVisite")
                                .HasColumnType("datetime2");

                            b1.Property<decimal?>("OD_Add")
                                .HasColumnType("decimal(18,2)");

                            b1.Property<int?>("OD_Axis")
                                .HasColumnType("int");

                            b1.Property<string>("OD_Cylinder")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("OD_Sphere")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<decimal?>("OS_Add")
                                .HasColumnType("decimal(18,2)");

                            b1.Property<int?>("OS_Axis")
                                .HasColumnType("int");

                            b1.Property<string>("OS_Cylinder")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("OS_Sphere")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("PD")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Optique_Domaine.Entities.Order", b =>
                {
                    b.HasOne("Optique_Domaine.Entities.Client", null)
                        .WithMany("Orders")
                        .HasForeignKey("ClientId");
            ...
            modelBuilder.Entity("Optique_Domaine.Entities.Facture", b =>
                {
                    b.HasOne("Optique_Domaine.Entities.Vente", "Vente")
                        .WithMany()
